...
window.SCHOOL = {
  ...
  font:    'oswald',
  fontFamily: 'Oswald',
  fontCss: 'Oswald:wght@300;400;500;600;700',
  layout:  'layout1',
  modules: ["academic_setup","students","staff","classes","subjects","attendance","cbt-prompts","entrance","results","certificates","flyer","report-cards","analytics","admin-data","academic_records","storage","approvals","timetable-generator","checkin","diary","surveys","menu","settings","timetable","cbt","sow","messages","announcements","events","gallery","library","digital_library","assignments","parents","idcards","directory","departments","broadcast","complaints","leave","visitors","developer","conduct","health","promotion","lms","gamification","career_counseling","lesson_plans","behaviour","support_plans","substitutions","admissions","hr","payroll","staff_loans","staff_bonus","appraisals","hostel","alumni","inventory","document_builder","fleet_tracking","facility_booking","compliance","activity_log","inbox","voting","parent_meeting","front_desk","helpdesk","eresources","birthdays","reports","school_calendar","lost_found","book_request","fees","finance","transport","cafeteria","financial_aid","donations","payments_online","rubrics","transcripts","transfer_cert","counselling"],
